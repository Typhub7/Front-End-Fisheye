export async function fetchPhotographersData() {
  try {
    ...
    console.error(error);
    const fallbackResponse = await import('https://typhub7.github.io/Front-End-Fisheye/data/photographers.json'); // Only for Gh Page Working -- Remove When back end is ready
